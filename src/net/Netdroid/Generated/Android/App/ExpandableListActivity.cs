...
namespace Android.App
{
    ...
    public partial class ExpandableListActivity
    {
        ...
        protected virtual void InitializeHandlers()
        {
            ...
            AddEventHandler("getSelectedPosition", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(GetSelectedPositionEventHandler));
            ...
            AddEventHandler("setSelectedGroup", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(SetSelectedGroupEventHandler));
        ...
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/android/app/ExpandableListActivity.html#getSelectedPosition()"/>
        /// </summary>
        /// <remarks>If <see cref="OnGetSelectedPosition"/> has a value it takes precedence over corresponding class method</remarks>
        public global::System.Func<long> OnGetSelectedPosition { get; set; } = null;
        
        bool hasOverrideGetSelectedPosition = true;
        void GetSelectedPositionEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            hasOverrideGetSelectedPosition = true;
            var methodToExecute = (OnGetSelectedPosition != null) ? OnGetSelectedPosition : GetSelectedPosition;
            var executionResult = methodToExecute.Invoke();
            data.EventData.TypedEventData.SetReturnData(hasOverrideGetSelectedPosition, executionResult);
        }
        ...
        {
            hasOverrideGetSelectedPosition = false; return default;
        }
        ...
        /// <summary>
        /// Handler for <see href="https://developer.android.com/reference/android/app/ExpandableListActivity.html#setSelectedGroup(int)"/>
        /// </summary>
        /// <remarks>If <see cref="OnSetSelectedGroup"/> has a value it takes precedence over corresponding class method</remarks>
        public global::System.Action<int> OnSetSelectedGroup { get; set; } = null;
        
        bool hasOverrideSetSelectedGroup = true;
        void SetSelectedGroupEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            hasOverrideSetSelectedGroup = true;
            var methodToExecute = (OnSetSelectedGroup != null) ? OnSetSelectedGroup : SetSelectedGroup;
            methodToExecute.Invoke(data.EventData.GetAt<int>(0));
            data.EventData.TypedEventData.HasOverride = hasOverrideSetSelectedGroup;
        }
        ...
        {
            hasOverrideSetSelectedGroup = false;
        }
